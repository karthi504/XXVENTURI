create or replace package xxventuri.xlib_jasperreports as
/*=========================================================================
  Purpose  : 
...
----------------------------------------------------------------------------
    procedure set_images_uri (
        p_images_uri in varchar2 default null
    );
    ...
    function get_cookie_path_no_tunnel return varchar2;
...
----------------------------------------------------------------------------
    function get_default_configuration return xlib_jasperreports_conf%rowtype;
...
-- sqlcl_snapshot {"hash":"1732bf6c807606aa8aeff0dd0ef7da264f7c14d8","type":"PACKAGE_SPEC","name":"XLIB_JASPERREPORTS","schemaName":"XXVENTURI","sxml":""}