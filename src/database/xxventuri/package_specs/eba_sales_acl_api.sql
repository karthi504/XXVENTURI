create or replace package xxventuri.eba_sales_acl_api is
    -------------------------------------------------------------------------
...
-- sqlcl_snapshot {"hash":"564da361de2703c89e63ae4be0006d7b465ee58e","type":"PACKAGE_SPEC","name":"EBA_SALES_ACL_API","schemaName":"XXVENTURI","sxml":""}